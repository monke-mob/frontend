...
/>
  ...
  <link rel="preload" href="/images/monke-mob/banner/600x600.webp" as="image">
  <link rel="preload" href="/images/monke-mob/banner/900x900.webp" as="image">
</svelte:head>
...
<style lang="postcss">
  :global(body) {
      @apply w-screen h-screen overflow-hidden text-center bg-no-repeat bg-gradient-to-b
from-backgroundSecondary to-background;
  }
